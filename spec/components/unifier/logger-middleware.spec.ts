...
describe("createUnifierLoggerMiddleware", function() {
  ...
  describe("with a valid extraction given", function() {
    it("created function returns child logger", function() {
      const childLogger = createUnifierLoggerMiddleware({ sessionID: 'mySessionID' } as any)(this.logger);
